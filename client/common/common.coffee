...
class window.Tournament extends Backbone.Model
	idAttribute: "_id"
	urlRoot: "/tournament"
	defaults:
		date: new Date()
...
class TournamentListCollection extends Backbone.Collection
	model: Tournament
	url: "/tournament"
	comparator: (t) ->
...
window.TournamentList = new TournamentListCollection()
